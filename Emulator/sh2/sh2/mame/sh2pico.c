...
#define RB(sh2, a) sh2->read8(a, sh2)
#define RW(sh2, a) sh2->read16(a, sh2)
#define RL(sh2, a) sh2->read32(a, sh2)
#define WB(sh2, a, d) sh2->write8(a, d, sh2)
#define WW(sh2, a, d) sh2->write16(a, d, sh2)
#define WL(sh2, a, d) sh2->write32(a, d, sh2)
...
int sh2_execute_interpreter(SH2 *sh2, int cycles, int trace)
{
	UINT32 opcode;
	...
	do
	{
		if (sh2->delay)
		{
            ...
            if (trace && (sh2->sr > saved_sr)) {                trace = 0;
                printf("\n");
            }
